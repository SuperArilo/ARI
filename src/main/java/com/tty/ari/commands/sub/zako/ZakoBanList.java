...
@CommandMeta(displayName = "banlist", permission = "ari.command.zako.banlist", tokenLength = 2, allowConsole = true)
...
public class ZakoBanList extends LiteralArgumentCommand {
    ...
    public List<SuperHandsomeCommand> thenCommands() {
        return List.of(new ZakoBanListArgs());
    }
    ...
    public static void Build_Zako_Ban_List(CommandSender sender, Integer pageNum) {
        ...
        .thenCompose(result -> {
            ...
            if (records.isEmpty()) {
                Ari.instance.getScheduler().run(i -> sender.sendMessage(Ari.instance.getEngine().directRender(Ari.DATA_SERVICE.getValue("base.page-change.none-next"))));
