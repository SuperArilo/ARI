...
@CommandMeta(displayName = "hour (int)", permission = "ari.command.zako.ban", tokenLength = 8, allowConsole = true)
@ArgumentCommand
public class ZakoBanHour extends RequiredArgumentCommand<Integer> {
